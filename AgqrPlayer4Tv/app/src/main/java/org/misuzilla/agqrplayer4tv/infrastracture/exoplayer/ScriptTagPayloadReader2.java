 ...
 */
/* package */ final class ScriptTagPayloadReader2 extends TagPayloadReader2 {
     ...
     */
    public ScriptTagPayloadReader2(TrackOutput output) {
        super(output);
    ...
    protected void parsePayload(ParsableByteArray data, long timeUs) throws ParserException {
        ...
        if (type != AMF_TYPE_ECMA_ARRAY) {
            // Should never happen.
            //throw new ParserException();
            return; // WORKAROUND: Sometimes come here
        }
