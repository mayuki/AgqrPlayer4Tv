 ...
 */
public final class FlvExtractor2 implements Extractor, SeekMap {

    /**
     * Factory for {@link FlvExtractor2} instances.
     */
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() {

        @Override
        public Extractor[] createExtractors() {
            return new Extractor[] {new FlvExtractor2()};
        }
    ...
    // Tags readers.
    private AudioTagPayloadReader2 audioReader;
    private VideoTagPayloadReader2 videoReader;
    private ScriptTagPayloadReader2 metadataReader;

    public FlvExtractor2() {
